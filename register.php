...
if (isset($_POST['btn_register'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        echo "<h1>Waduh, Error!</h1>";
        echo "Pesan Error: " . mysqli_error($conn);
        echo "<br>Query yang dikirim: " . $sql;
        exit;
    }
    } else {
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="register.php" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="email" name="email_user" class="form-control form-control-user" id="exampleInputEmail" placeholder="Email Address">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" name="pass_user" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password">
                                    </div>
                                    <div class="col-sm-6">
